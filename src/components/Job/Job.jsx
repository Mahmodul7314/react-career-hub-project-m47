...
const Job = ({job}) => {
  ...
  <div className="card-body">
    ...
    <div className="flex mt-4">
      <h2 className="flex mr-4"><MdLocationOn className="text-2xl mr-4"></MdLocationOn>{location}</h2>
      <h2 className="flex"><AiOutlineDollar className="text-2xl mr-4"></AiOutlineDollar>{salary}</h2>
    </div>
